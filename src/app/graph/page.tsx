...
import { Lock, CheckCircle, GitBranch } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 md:p-8 animate-fade-in">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-2">Select an available concept to begin. You'll unlock more as you go!</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {nodesInOrder.map(node => {
          ...
          const NodeContent = (
            <Card
              className={cn(
                "h-full flex flex-col text-center transition-all duration-300 transform",
                isAvailable && "hover:-translate-y-1 border-primary border-2 shadow-lg",
